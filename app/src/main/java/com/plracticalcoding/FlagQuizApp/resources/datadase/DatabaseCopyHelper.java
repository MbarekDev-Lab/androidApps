package com.plracticalcoding.FlagQuizApp.resources.datadase;
...
public class DatabaseCopyHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS flagquizgametable (flag_id INTEGER, country_name TEXT, flag_name TEXT)");
