package com.plracticalcoding.mp3player;
...
public class Mp3PLayerMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (ContextCompat.checkSelfPermission(Mp3PLayerMainActivity.this, Manifest.permission.READ_MEDIA_AUDIO)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Mp3PLayerMainActivity.this
            ...
            if (ContextCompat.checkSelfPermission(Mp3PLayerMainActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Mp3PLayerMainActivity.this
    ...
    public void getAllAudioFiles() {
        ...
        adapter = new MusicAdapter(songList, Mp3PLayerMainActivity.this);
