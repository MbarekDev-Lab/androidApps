...
import com.plracticalcoding.myapplication.databinding.ActivityWeatheBinding;
...
import com.plracticalcoding.restWeatherApp.viewmodel.WeatherViewModel;
import com.squareup.picasso.Callback;
import com.squareup.picasso.Picasso;

public class WeatherActivity extends AppCompatActivity implements NetworkStatusListener {
    ActivityWeatheBinding weatherBinding;
    String prefer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherBinding = ActivityWeatheBinding.inflate(getLayoutInflater());
