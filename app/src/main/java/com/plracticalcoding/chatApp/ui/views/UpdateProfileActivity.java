...
import com.plracticalcoding.myapplication.databinding.ActivityUpdateProfileBinding;
...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    public void shouldShowPermissionRationaleIfNeeded(){
        ...
        if (!deniedPermissions.isEmpty()){
            ...
            Snackbar.make(updateProfileBinding.getRoot(),"Please grant necessary permissions to add a profile photo",Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK",v -> {
