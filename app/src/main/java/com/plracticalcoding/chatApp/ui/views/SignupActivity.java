...
public class SignupActivity extends AppCompatActivity {
    ...
    public void saveUserInfoToDatabase() {
        ...
        databaseReference.child(userUniqueId).setValue(user).addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                Intent intent = new Intent(SignupActivity.this, MainActivityChatApp.class);
    ...
    public void shouldShowPermissionRationaleIfNeeded() {
        ...
        if (!deniedPermissions.isEmpty()) {
            ...
            Snackbar.make(signupBinding.getRoot(), "Please grant necessary permissions to add a profile photo", Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK", v -> {
